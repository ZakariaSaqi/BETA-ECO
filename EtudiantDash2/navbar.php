      ...
      <div class="navbar-nav-wrapper">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item"><a href="#about" class="nav-link">Conversation</a></li>
            <li class="nav-item"><a href="#services" class="nav-link">Cours</a></li>
            <li class="nav-item"><a href="#annonces" class="nav-link">Séances</a></li>
