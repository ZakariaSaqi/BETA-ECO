                            ...
                            if ($_POST['psw'] == $_POST['cpsw']) {
                                ...
                                if (preg_match($phoneRegex, $_POST['phone']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
                                    ...
                                    if (checkdnsrr($domain, 'MX')) {
                                        ...
                                        $req2 = "update utilisateurs set prenom ='" . ucfirst($_POST['prenom']) . "', nom= '" . strtoupper($_POST['nom']) . "', phone= '" . $_POST['phone'] . "', phone= '" . $_POST['phone'] . "', email='" . $_POST['email'] . "', service ='" . $srv. "', login ='" . $_POST['login'] . "', psw = '" . $_POST['psw'] . "'
