        ...
        <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
            ...
            <div class="container-fluid">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                        $req .= " ORDER BY id_cours DESC LIMIT $startIndex, $resultsPerPage";
                        $res = $pdo->query($req);
                        if ($res->rowCount() > 0) {
                            foreach ($res as $data) {
                                ?>
                                <tr>
                                    ...
                                    <td class="row ">
                                        <a href="operations_demande.php?action=view&id=" class="view col-3" title="Téléchatger"
                                            data-toggle="tooltip"><i class="fa-sharp fa-solid fa-download"></i></a>
                                        <a href="operations_demande.php?action=view&id=" class="view col-3" title="View"
                                            data-toggle="tooltip"><i class="fa-solid fa-circle-info"></i></a>
                                        <a href="operations_demande.php?action=Edit&id=" class="edit col-3" title="Edit"
                                            data-toggle="tooltip"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="operations_demande.php?action=Delete&id=" class="delete col-3" title="Delete"
