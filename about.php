			...
			<div class="row">
				...
				<div class="col-lg-6 pl-lg-5">
					<div class="heading-section mb-5 mt-5 mt-lg-0">
						...
						<p>Trouvez les réponses à vos questions fréquemment posées : résolution de problèmes, gestion des prêts commerciaux et croissance de vos fonds d'investissement.</p>
					</div>
							...
							<div class="collapse show" id="collapseOne" role="tabpanel" aria-labelledby="headingOne">
								<div class="card-body py-3 px-0">
									<ol>
										...
										<li>Générez des idées de solutions en utilisant des techniques de brainstorming.</li>
										<li>Évaluez chaque solution potentielle en examinant ses avantages et ses inconvénients.</li>
										<li>Sélectionnez la meilleure solution et créez un plan d'action pour sa mise en œuvre.</li>
										<li>Mettez en œuvre le plan, surveillez les résultats et apportez les ajustements nécessaires.</li>
									</ol>
								</div>
							</div>
						</div>
					<div class="card">
						...
						<div class="collapse" id="collapseTwo" role="tabpanel" aria-labelledby="headingTwo">
							<div class="card-body py-3 px-0">
									<ol>
									<li>Analysez votre situation financière pour comprendre votre capacité à rembourser les prêts.</li>
									<li>Établissez un budget réaliste et allouez des fonds pour les remboursements.</li>
									<li>Communiquez régulièrement avec vos créanciers pour discuter de tout problème ou retard de paiement potentiel.</li>
									<li>Explorez les options de refinancement ou de restructuration de vos prêts si vous avez du mal à les rembourser.</li>
									<li>Faites preuve de discipline financière en évitant de contracter de nouveaux prêts si votre situation est précaire.</li>
								</ol>
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingTwo">
							<div class="card-body py-3 px-0">
								<ol>
									<li>Définissez des objectifs d'investissement clairs en termes de rendement, de risque et de durée.</li>
									<li>Diversifiez vos investissements en répartissant vos fonds sur différents actifs, secteurs ou régions géographiques.</li>
									<li>Faites des recherches approfondies sur les opportunités d'investissement et suivez de près les marchés financiers.</li>
									<li>Surveillez et évaluez régulièrement les performances de vos investissements, en ajustant si nécessaire votre stratégie.</li>
									<li>Consultez un conseiller financier qualifié pour obtenir des conseils personnalisés en fonction de votre profil d'investisseur.</li>
								</ol>
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div class="collapse" id="collapseFour" role="tabpanel" aria-labelledby="headingTwo">
							...
							<ol>
									...
									<li>Respect des réglementations locales en matière de licences et de permis d'exploitation.</li>
									...
									<li>Conformité aux règles de protection des consommateurs et de la vie privée.</li>
