        ...
        if($_POST['psw'] == $_POST['cpsw'] ){
            ...
            if (preg_match($phoneRegex, $_POST['phone']) && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
              ...
              if (checkdnsrr($domain, 'MX')) {
                $req2 = "update utilisateurs set prenom ='".$_POST['prenom']."', nom= '".$_POST['nom']."', phone= '".$_POST['phone']."', email='".$_POST['email']."', adresse ='".$_POST['adresse']."', login ='".$_POST['login']."', psw = '".$_POST['psw']."'
                where id_user =".$_SESSION['id'];
                $res2 = $pdo -> query($req2);
                header('location:index.php');
              }  else echo "<center>Numero de téléphone ou adresse non valide !</center>";
            } else echo "<center>Numero de téléphone ou adresse non valide !</center>";
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                       <input type="text" class="form-control" name="prenom" id="" value="<?= $row['prenom'] ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="nom" id="" value="<?= $row['nom'] ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                       <input type="text" class="form-control" name="phone" id="" value="<?= $row['phone'] ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="adresse" id="" value="<?= $row['adresse'] ?>">
                                    </div>
                                </div>
                                <hr>
                            </div>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="" id="" value="<?= $row['niveau'] ?>" disabled>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="login" id="" value="<?= $row['login'] ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="psw" id="" value="<?= $row['psw'] ?>">
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control" name="cpsw" id="" value="<?= $row['psw'] ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
